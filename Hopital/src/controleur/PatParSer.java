...
/**
 * Classe qui permet la recherche du nombre de patients par service dans la base
 * ( herite de JPanel )
 *
 * @author Aude et Hugo
 */
public class PatParSer extends JPanel {
    ...
    /**
     *
     * @param dataset Parametre du graph
     * @return Graph cree et parametré
     */
    private JFreeChart createChart(PieDataset dataset) {
        JFreeChart chart = ChartFactory.createPieChart(
                "Nombre de patients par service", // chart title
                dataset, // data
