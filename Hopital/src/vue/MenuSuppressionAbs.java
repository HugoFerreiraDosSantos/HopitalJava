...
/**
 * Class abstraite qui gere la vue de MenuSuppression
 *
 * @author Aude et Hugo
 */
public abstract class MenuSuppressionAbs extends JPanel {
     ...
     */
    public MenuSuppressionAbs(HopitalGraphique hop) {
