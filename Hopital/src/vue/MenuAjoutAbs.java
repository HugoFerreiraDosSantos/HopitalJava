...
/**
 * Class abstraite qui gere la vue de MenuAjout
 *
 * @author Aude et Hugo
 */
public abstract class MenuAjoutAbs extends JPanel {
     ...
     */
    public MenuAjoutAbs(HopitalGraphique hop) {
    ...
    private void build() {
        ...
        for (String res : resultats) {
            onglets.addTab(res, new Ajout(hopGraph, res));
        }
